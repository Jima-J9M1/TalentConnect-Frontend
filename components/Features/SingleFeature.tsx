...
const SingleFeature = ({ feature }: { feature: Feature }) => {
  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className="wow fadeInUp group mb-12 flex sm:flex-col items-center justify-between gap-4" data-wow-delay=".15s">
        <div>
        ...
        <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-11 sm:text-center">
          {paragraph}
        </p>
        </div>
      </div>
