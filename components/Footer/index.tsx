import { talent_logo_dark } from "@/app/lib/constant/image-constant";
...
const Footer = () => {
  return (
    <footer
      ...
      data-wow-delay=".15s"
    >
      <div className="container mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
        <div className="-mx-4 sm:flex justify-around">
            ...
            <div className="mb-10 w-full">
              <Link href="/" className=" inline-block">
                <Image
                  ...
                  width={80}
                  height={10}
                  className="max-w-full scale-150 pl-2"
                />
              </Link>
          ...
          <div>
          <p className="text-lg font-semibold pb-2  text-white">Follow Us</p>
